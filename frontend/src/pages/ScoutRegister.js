        ...
        >
          ...
          <fieldset id="form-club-register-scout">
            ...
            <input
              type="text"
              name="club"
              id="club-register-scout"
              className={`${isFieldValid("club")}`}
              ref={register({ required: "* Campo requerido" })}
            />
          ...
          <fieldset id="form-repeat-password-register-scout">
            ...
            <input
              type="password"
              name="repeat"
              id="repeat-password-register-scout"
