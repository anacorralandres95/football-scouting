...
import { AllMyVideosList } from "../components/AllMyVideosList";
...
function MyVideosReducer(state, action) {
  switch (action.type) {
    case "GET_MYVIDEOS_SUCCESS":
      return { ...state, myvideos: action.initialMyVideos };

    case "SELECT_MYVIDEO":
      return {
        ...state,
        selectedMyVideo: action.index,
      };
...
function MyVideos() {
  ...
  const initialMyVideos = state.myvideos;
        ...
        <section className="filters">
          <form id="filters">
            ...
            <fieldset id="strenght-fieldset">
              ...
              <input
                className="range-strenght-filter"
                type="range"
                value="0"
                min="0"
                max="16"
            ...
            <fieldset id="velocity-fieldset">
              ...
              <input
                className="range-velocity-filter"
                type="range"
                value="0"
                min="0"
                max="16"
            ...
            <fieldset id="technique-fieldset">
              ...
              <input
                className="range-technique-filter"
                type="range"
                value="0"
                min="0"
                max="16"
            ...
            <fieldset id="ball-hit-fieldset">
              ...
              <input
                className="range-ball-hit-filter"
                type="range"
                value="0"
                min="0"
                max="16"
            ...
            <fieldset id="ball-stop-fieldset">
              ...
              <input
                className="range-ball-stop-filter"
                type="range"
                value="0"
                min="0"
                max="16"
